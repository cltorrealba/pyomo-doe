...
NATURAL_MUST_FILE = DATA_DIR / "mosto_natural_xthiol.xlsx"
SYNTHETIC_MUST_FILE = DATA_DIR / "mosto_sintetico_vl3.xlsx"
...
def _save_open_excel_copy(path: Path) -> Path | None:
    ...
    target = DATA_DIR / f"_tmp_{Path(path).stem}_readcopy.xlsx"
    try:

...
from shared import run_secondary_metabolite_data_review as secondary_review
from shared.paths import SHARED_RESULTS_DIR


RESULTS_DIR = SHARED_RESULTS_DIR / "secondary_joint_campaign_doe"
NOTEBOOK_PATH = (
    SHARED_DIR
    / "notebooks"
...
def load_reference_theta() -> dict[str, float]:
    ...
    candidates = [
        SHARED_RESULTS_DIR / "new_must_glycerol_overnight_validation" / "theta_multistart_07.csv",
        SHARED_RESULTS_DIR / "new_must_glycerol_overnight_validation" / "theta_reference.csv",
        SHARED_RESULTS_DIR / "new_must_glycerol_estimability_doe" / "theta_mixed_full17_l2.csv",
    ]
...
def write_notebook() -> None:
    ...
    nb.cells = [
        ...
        nbformat.v4.new_code_cell(
            ...
            "RESULTS = ROOT / 'shared/results/secondary_joint_campaign_doe'\n"

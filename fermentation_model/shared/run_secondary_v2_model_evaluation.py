...
from shared import run_secondary_joint_campaign_doe as v1
from shared.paths import SHARED_RESULTS_DIR


RESULTS_DIR = SHARED_RESULTS_DIR / "secondary_v2_model_evaluation"
NOTEBOOK_PATH = (
    SHARED_DIR
    / "notebooks"
...
def write_notebook() -> None:
    ...
    nb.cells = [
        ...
        nbformat.v4.new_code_cell(
            ...
            "RESULTS = ROOT / 'shared/results/secondary_v2_model_evaluation'\n"

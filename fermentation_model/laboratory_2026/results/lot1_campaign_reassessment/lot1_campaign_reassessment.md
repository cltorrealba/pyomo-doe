...
Generated from `fermentation_lot1_data_preview.executed.ipynb` processed outputs and the selected DOE bundle now archived in `laboratory_2026/archive/design_execution_copy_2026-06-09/rec`.

...
RESULTS_DIR = LABORATORY_2026_RESULTS_DIR / "lot1_pulse_timing_mbdoe"
...
def main() -> None:
    ...
    protocol = pd.read_csv(LABORATORY_2026_RESULTS_DIR / "final_operational_doe_volume_constrained" / "campaign_protocol.csv")

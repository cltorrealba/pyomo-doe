...
NOTEBOOK_PATH = LABORATORY_DIR / "notebooks" / "fermentation_lot1_data_preview.ipynb"
...
nb["cells"] = [
    ...
    code(
        ...
        RESULTS_DIR = ROOT / "fermentation_model" / "laboratory_2026" / "results" / "lot1_data_preview"
    ...
    md(
        ...
        - Planned pulses are read from the authoritative design bundle under
          `fermentation_model/laboratory_2026/results/design_execution_bundle_2026-06-09/`.

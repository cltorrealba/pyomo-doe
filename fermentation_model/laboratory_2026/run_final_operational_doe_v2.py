...
RESULTS_DIR = LABORATORY_2026_RESULTS_DIR / "final_operational_doe_v2"
NOTEBOOK_PATH = SCRIPT_DIR / "notebooks" / "fermentation_final_operational_doe_v2.ipynb"
...
def load_theta_final() -> dict[str, float]:
    ...
    for path in [
        ...
        v2.RESULTS_DIR / "theta_secondary_v2_reduced_o2fixed.csv",
    ]:
        if path.exists():
